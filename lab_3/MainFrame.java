package bsu.rfe.java.group9.lab3.Karasev.LAB_3;
...
public class MainFrame extends JFrame
{
    ...
    private MainFrame(Double[] coefficients)
    {
        ...
        Action aboutAction = new AbstractAction("О программе")
        {
            public void actionPerformed(ActionEvent event)
            {
                JOptionPane.showMessageDialog(MainFrame.this, "9 группа, Карасев Константин Тарасович", "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
